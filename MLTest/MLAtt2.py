...
first_meas_df.drop(['DIST','ANCHS','AN0','ID0','AN1','ID1','AN2','ID2','AN3','ID3','POS','PREC','Z'],axis=1,inplace=True) #(0.75;0.95)
snd_meas_df.drop(['DIST','ANCHS','AN0','ID0','AN1','ID1','AN2','ID2','AN3','ID3','POS','PREC','Z'],axis=1,inplace=True) # (0.9;2.6)
trd_meas_df.drop(['DIST','ANCHS','AN0','ID0','AN1','ID1','AN2','ID2','AN3','ID3','POS','PREC','Z'],axis=1,inplace=True) #(1.45;0.45)
frth_meas_df.drop(['DIST','ANCHS','AN0','ID0','AN1','ID1','AN2','ID2','AN3','ID3'],axis=1,inplace=True)
fith_meas_df.drop(['DIST','ANCHS','AN0','ID0','AN1','ID1','AN2','ID2','AN3','ID3','POS','PREC','Z'],axis=1,inplace=True) #(1.6;2.0)
